...
var LFCM;(function () { if (!LFCM || !LFCM.requirejs) {
if (!LFCM) { LFCM = {}; } else { require = LFCM; }
/**
...
LFCM.requirejs = requirejs;LFCM.require = require;LFCM.define = define;
}
}());
LFCM.define("almond", function(){});

LFCM.define('text',{});
LFCM.define('json',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});

LFCM.define("json!lib/json/timezone.json", function(){ return {
	"links": {
...
LFCM.define('collection-manager',['require','exports','module','json!lib/json/timezone.json'],function (require, exports, module) {
