...
define("json!lib/json/timezone.json", function(){ return {
	"links": {
...
define('collection-manager',['require','exports','module','json!lib/json/timezone.json'],function (require, exports, module) {
